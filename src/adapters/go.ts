...
import type { Adapter, Update } from './types.ts';
...
export function parseGoMod(text: string | null | undefined): Map<string, Requirement> {
...
export function mergeGoSum(base: string | null | undefined, head: string | null | undefined): string {
